...
namespace SolrExpress.Benchmarks.Solr4.Query.Result
{
    public class DocumentResultBenchmarks
    {
        ...
        public void Setup()
        {
            ...
            var str10 = EmbeddedResourceHelper.GetByName(assembly, "Solr4.Query.Result.DocumentResultBenchmarks10");
            var str100 = EmbeddedResourceHelper.GetByName(assembly, "Solr4.Query.Result.DocumentResultBenchmarks100");
            var str500 = EmbeddedResourceHelper.GetByName(assembly, "Solr4.Query.Result.DocumentResultBenchmarks500");
            var str1000 = EmbeddedResourceHelper.GetByName(assembly, "Solr4.Query.Result.DocumentResultBenchmarks1000");
