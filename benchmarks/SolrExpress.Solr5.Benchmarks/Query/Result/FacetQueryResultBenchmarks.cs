...
namespace SolrExpress.Benchmarks.Solr5.Query.Result
{
    public class FacetQueryResultBenchmarks
    {
        ...
        public void Setup()
        {
            ...
            var str10 = EmbeddedResourceHelper.GetByName(assembly, "SolrExpress.Benchmarks.Solr5.Query.Result.FacetQueryResultBenchmarks10");
            var str100 = EmbeddedResourceHelper.GetByName(assembly, "SolrExpress.Benchmarks.Solr5.Query.Result.FacetQueryResultBenchmarks100");
            var str500 = EmbeddedResourceHelper.GetByName(assembly, "SolrExpress.Benchmarks.Solr5.Query.Result.FacetQueryResultBenchmarks500");
            var str1000 = EmbeddedResourceHelper.GetByName(assembly, "SolrExpress.Benchmarks.Solr5.Query.Result.FacetQueryResultBenchmarks1000");
