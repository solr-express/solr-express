...
namespace SolrExpress.Benchmarks.Solr5.Query.Result
{
    public class FacetFieldResultBenchmarks
    {
        ...
        public void Setup()
        {
            ...
            var str10 = EmbeddedResourceHelper.GetByName(assembly, "FacetFieldResultBenchmarks10");
            var str100 = EmbeddedResourceHelper.GetByName(assembly, "FacetFieldResultBenchmarks100");
            var str500 = EmbeddedResourceHelper.GetByName(assembly, "FacetFieldResultBenchmarks500");
            var str1000 = EmbeddedResourceHelper.GetByName(assembly, "FacetFieldResultBenchmarks1000");
        ...
        public void FacetFieldResultWith10Parameters()
        {
        ...
        /// </summary>
        [Benchmark]
        public void FacetFieldResultWith100Parameters()
        {
        ...
        /// </summary>
        [Benchmark]
        public void FacetFieldResultWith500Parameters()
        {
        ...
        /// </summary>
        [Benchmark]
        public void FacetFieldResultWith1000Parameters()
        {
