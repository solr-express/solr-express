...
{
    /// <summary>
    ///  Process parsing of facets of type range
    /// </summary>
    internal class ProcessFacetRanges<TDocument>
        where TDocument : Document
    {
        ...
        internal FacetItemRange Execute(List<ISearchParameter> searchParameters, JsonReader jsonReader)
        {
