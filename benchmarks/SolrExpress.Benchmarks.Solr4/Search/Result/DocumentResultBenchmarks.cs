...
namespace SolrExpress.Benchmarks.Solr4.Search.Result
{
    public class DocumentResultBenchmarks
    {
        ...
        public void Setup()
        {
            ...
            this._jsonPlainText = EmbeddedResourceHelper.GetByName(assembly, $"SolrExpress.Benchmarks.Solr4.Search.Result.DocumentResultBenchmarks{this.ElementsCount}.json");
        }
