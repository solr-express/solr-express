...
{
    public class BaseSpatialFilterParameterTests
    {
        /// <summary>
        /// Where   Using a BaseSpatialFilterParameter instance
        /// When    Invoking method "Equals" using same instance
        /// What    Returns true
        /// </summary>
        [Fact]
        public void BaseSpatialFilterParameter001()
        {
            // Arrange
        ...
        /// </summary>
        [Fact]
        public void BaseSpatialFilterParameter002()
        {
            // Arrange
            var solrOptions = new SolrExpressOptions();
            var solrConnection = new FakeSolrConnection<TestDocument>();
            ...
            var parameter2 = new Mock<BaseSpatialFilterParameter<TestDocument>>
            {
                CallBase = true
            }.Object;
        ...
        /// </summary>
        [Fact]
        public void BaseSpatialFilterParameter003()
        {
            // Arrange
            var parameter1 = new Mock<BaseSpatialFilterParameter<TestDocument>>
            {
