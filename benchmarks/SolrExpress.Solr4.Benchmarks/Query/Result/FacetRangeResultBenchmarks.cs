...
namespace SolrExpress.Benchmarks.Solr4.Query.Result
{
    public class FacetRangeResultBenchmarks
    {
        ...
        public void Setup()
        {
            ...
            var str10 = EmbeddedResourceHelper.GetByName(assembly, "SolrExpress.Benchmarks.Solr4.Query.Result.FacetRangeResultBenchmarks10");
            var str100 = EmbeddedResourceHelper.GetByName(assembly, "SolrExpress.Benchmarks.Solr4.Query.Result.FacetRangeResultBenchmarks100");
            var str500 = EmbeddedResourceHelper.GetByName(assembly, "SolrExpress.Benchmarks.Solr4.Query.Result.FacetRangeResultBenchmarks500");
            var str1000 = EmbeddedResourceHelper.GetByName(assembly, "SolrExpress.Benchmarks.Solr4.Query.Result.FacetRangeResultBenchmarks1000");
