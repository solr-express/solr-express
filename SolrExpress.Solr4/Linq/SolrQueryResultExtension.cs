...
namespace SolrExpress.Solr4.Linq
{
    ...
    public static class SolrQueryResultExtension
    {
        ...
        {
            data = solrQueryResult.Get(new Solr4.Builder.DocumentBuilder<TDocument>()).Data;
        ...
        {
            data = solrQueryResult.Get(new Solr4.Builder.FacetFieldResultBuilder()).Data;
        ...
        {
            data = solrQueryResult.Get(new Solr4.Builder.FacetQueryResultBuilder()).Data;
        ...
        {
            data = solrQueryResult.Get(new Solr4.Builder.FacetRangeResultBuilder()).Data;
        ...
        {
            var builder = solrQueryResult.Get(new Solr4.Builder.StatisticResultBuilder());
