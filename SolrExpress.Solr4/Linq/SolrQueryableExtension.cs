...
namespace SolrExpress.Solr4.Linq
{
    /// <summary>
    ...
    public static class SolrQueryableExtension
    {
        ...
        public static SolrQueryable<TDocument> FieldList<TDocument>(this SolrQueryable<TDocument> solrQueryable, params Expression<Func<TDocument, object>>[] expressions)
            where TDocument : IDocument
        {
            return solrQueryable.Parameter(new FieldListParameter<TDocument>(expressions));
        }
        ...
        public static SolrQueryable<TDocument> FilterQuery<TDocument>(this SolrQueryable<TDocument> solrQueryable, Expression<Func<TDocument, object>> expression, string value)
            where TDocument : IDocument
        {
            var paramaterValue = new SingleValue<TDocument>(expression, value);
            return solrQueryable.Parameter(new FilterQueryParameter(paramaterValue));
        }
        ...
        public static SolrQueryable<TDocument> FilterQuery<TDocument, TValue>(this SolrQueryable<TDocument> solrQueryable, Expression<Func<TDocument, object>> expression, TValue? from, TValue? to)
            where TDocument : IDocument
            where TValue : struct
        {
            var value = new RangeValue<TDocument, TValue>(expression, from, to);
            return solrQueryable.Parameter(new FilterQueryParameter(value));
        }
        
        /// <summary>
        /// Create a rows parameter
        /// </summary>
        /// <param name="solrQueryable">The solr query</param>
        /// <param name="value">Parameter to include in the query</param>
        public static SolrQueryable<TDocument> Rows<TDocument>(this SolrQueryable<TDocument> solrQueryable, int value)
            where TDocument : IDocument
        {
            return solrQueryable.Parameter(new RowsParameter(value));
        }
        ...
        /// <param name="solrQueryable">The solr query</param>
        /// <param name="value">Parameter to include in the query</param>
        public static SolrQueryable<TDocument> Start<TDocument>(this SolrQueryable<TDocument> solrQueryable, int value)
            where TDocument : IDocument
        {
            return solrQueryable.Parameter(new StartParameter(value));
        }
