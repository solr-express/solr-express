...
namespace SolrExpress.Solr4.Parameter
{
        ...
        where TDocument : IDocument
    {
        ...
        {
            return new FieldListParameter<TDocument>(expressions);
        }
        ...
        {
            return new FilterQueryParameter(value, tagName);
        }
        ...
        {
            return new RowsParameter(value);
        }
        ...
        {
            return new StartParameter(value);
        }
