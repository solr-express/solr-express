...
namespace SolrExpress.Solr4.Builder
{
    ...
    /// </summary>
    public sealed class FacetFieldResultBuilder<TDocument> : IFacetFieldResultBuilder<TDocument>, IConvertJsonObject
        where TDocument : IDocument
    {
        ...
        {
            ThrowHelper<UnexpectedJsonFormatException>.If(jsonObject["facet_counts"]?["facet_fields"] == null, jsonObject.ToString());
